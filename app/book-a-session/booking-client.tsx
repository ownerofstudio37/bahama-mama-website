...
export default function BookSessionPage() {
  ...
  const [loadingSlots] = useState(false)
  ...
  const onSubmit = async (e: React.FormEvent) => {
    ...
    console.log('Demo mode: Booking would be saved:', {
      name, email, phone, selectedType, selectedDate, selectedTime, duration, notes
    })
  ...
  const bgUrl = 'https://images.unsplash.com/photo-1423666639041-f56000c27a9a'

  return (
    <div className="relative min-h-screen flex flex-col">
      <div className="fixed top-0 left-0 w-screen h-screen -z-10 pointer-events-none">
        <Image src={bgUrl} alt="Book a session background" fill className="object-cover" priority sizes="100vw" />
        <div className="absolute inset-0 bg-black bg-opacity-40 backdrop-blur-sm" aria-hidden="true" role="presentation" />
      </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
              ...
              <div className="lg:col-span-2">
                <div className="bg-white rounded-lg shadow p-6">
                  ...
                  <div className="mt-6">
                    <button type="submit" disabled={!name || !email || !selectedDate || !selectedTime || submitting} className="btn-primary px-6 py-3 disabled:opacity-50">
